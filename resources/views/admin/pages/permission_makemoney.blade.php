                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-success"><a href="{{ route('admin.make-status',[$item->id,$item->status])  }}">Active</a>
                            </button>
                            @else
                            <button type="button" class="btn "  style="background: #673ab7;color:white"><a href="{{ route('admin.make-status',[$item->id,$item->status])  }}" >Inactive</a>
                            </button>
                            @endif
