    ...
    <div class="container">
      ...
      <div class="ps-footer__copyright">
        ...
        <p><span>We Using Safe Payment For:</span>
            ...
            <a href="#"><img src="{{ asset('front_end/img/payment-method/3.jpg') }}" alt=""></a>
            <a href="#"><img src="{{ asset('front_end/img/payment-method/4.jpg') }}" alt=""></a>
            <a href="#"><img src="{{ asset('front_end/img/payment-method/5.jpg') }}" alt=""></a>
        </p>
      </div>
    </div>
  </footer>